...
/**
 * 处理与EventAuditEntity相关的请求的Controller。
 * 继承自BaseController类并实现IEventAuditService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class EventAuditController extends BaseController<EventAuditEntity, IEventAuditService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(EventAuditController.class);

    @Autowired
    private IEventAuditService service;

    /**
     * 获取EventAuditEntity的DataTables数据。
     *
    ...
    @Override
    public IEventAuditService getFeign() {
        return this.service;
    }
}

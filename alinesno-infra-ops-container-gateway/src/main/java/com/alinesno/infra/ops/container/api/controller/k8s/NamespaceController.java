...
import com.alinesno.infra.ops.container.k8s.nodes.NamespaceV1;
...
@RequestMapping("/api/infra/ops/container/k8s/namespace")
public class NamespaceController extends KubernetesAdapter {

    @ResponseBody
    @PostMapping("/datatables")
    public TableDataInfo datatables(DatatablesPageBean page) {
        log.debug("page = {}", ToStringBuilder.reflectionToString(page));
        KubernetesPageBean<NamespaceV1.NamespaceInfo> kubePage = NamespaceV1.queryByPage(getApiClient() , page) ;

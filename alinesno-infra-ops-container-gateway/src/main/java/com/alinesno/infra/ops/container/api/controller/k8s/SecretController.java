...
import com.alinesno.infra.ops.container.k8s.secret.SecretV1;
...
@RequestMapping("/api/infra/ops/container/k8s/secret")
public class SecretController extends KubernetesAdapter {

    @ResponseBody
    @PostMapping("/datatables")
    public TableDataInfo datatables(DatatablesPageBean page) {
        log.debug("page = {}", ToStringBuilder.reflectionToString(page));
        KubernetesPageBean<SecretV1.SecretInfo> kubePage = SecretV1.queryByPage(getApiClient() , page , getNamespace()) ;

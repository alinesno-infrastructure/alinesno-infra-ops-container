...
import com.alinesno.infra.ops.container.k8s.ingress.IngressV1;
...
@RequestMapping("/api/infra/ops/container/k8s/ingress")
public class IngressController extends KubernetesAdapter {

    @ResponseBody
    @PostMapping("/datatables")
    public TableDataInfo datatables(DatatablesPageBean page) {
        log.debug("page = {}", ToStringBuilder.reflectionToString(page));
        KubernetesPageBean<IngressV1.IngressInfo> kubePage = IngressV1.queryByPage(getApiClient() , page , getNamespace()) ;

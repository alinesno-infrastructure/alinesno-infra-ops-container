...
@RequestMapping("/api/infra/ops/container/k8s/pod")
public class PodController extends KubernetesAdapter {

    @ResponseBody
    @PostMapping("/datatables")
    public TableDataInfo datatables(DatatablesPageBean page) {
        log.debug("page = {}", ToStringBuilder.reflectionToString(page));
        KubernetesPageBean<PodV1.PodInfo> kubePage = PodV1.queryByPage(getApiClient() , page , getNamespace()) ;

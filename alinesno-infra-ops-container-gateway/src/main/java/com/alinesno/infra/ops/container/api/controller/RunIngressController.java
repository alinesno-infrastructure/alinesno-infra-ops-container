...
/**
 * 处理与RunIngressEntity相关的请求的Controller。
 * 继承自BaseController类并实现IRunIngressService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class RunIngressController extends BaseController<RunIngressEntity, IRunIngressService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(RunIngressController.class);

    @Autowired
    private IRunIngressService service;

    /**
     * 获取RunIngressEntity的DataTables数据。
     *
    ...
    @Override
    public IRunIngressService getFeign() {
        return this.service;
    }
}
